 ...
 $con=conectar();
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      $passw = openssl_encrypt($passw,"AES-256-ECB","M2M3M2");
        ...
        //$resultt = mysqli_query($con,"update alumno set nombre = '$nombre', matricula = '$matricula', passw = '$passw' where cod_estudiante = '$cod_estudiante'");
...
<?php include("./encabezado.php"); ?>
                <div class="container mt-5">
                     <form  method="POST">
                            ...
                            <input type="submit" class="btn btn-primary btn-block" value="Cifrar">
